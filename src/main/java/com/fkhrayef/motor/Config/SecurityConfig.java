...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf().disable()
                ...
                .requestMatchers("/api/v1/users/register", "/docs", "/swagger-ui/**", "/v3/api-docs/**", "/api/v1/payments/webhook","/api/v1/payments/callback").permitAll()
                .requestMatchers("/api/v1/transfer-requests/incoming", "/api/v1/transfer-requests/outgoing").hasAuthority("USER")
                ...
                .requestMatchers("/api/v1/users/update/{id}", "/api/v1/users/upload-license/{id}", "/api/v1/users/download-license/{id}", "/api/v1/users/delete-license/{id}", "/api/v1/users/{id}/subscription", "/api/v1/users/{id}/card", "/api/v1/car-ai/upload-manual/{carId}", "/api/v1/car-ai/ask/{carId}", "/api/v1/car-ai/car/{carId}/info", "/api/v1/cars/add", "/api/v1/cars/update/{id}", "/api/v1/cars/update/{carId}/mileage", "/api/v1/cars/delete/{id}", "/api/v1/cars/get/user", "/api/v1/cars/upload-registration/{id}", "/api/v1/cars/download-registration/{id}", "/api/v1/cars/delete-registration/{id}", "/api/v1/cars/upload-insurance/{id}", "/api/v1/cars/download-insurance/{id}", "/api/v1/cars/delete-insurance/{id}", "/api/v1/cars/visit-frequency/{make}/{model}", "/api/v1/cars/typical-mileage/{make}/{model}", "/api/v1/transfer-requests/direct/{carId}/{toEmail}/{toPhone}", "/api/v1/transfer-requests/{id}/accept", "/api/v1/transfer-requests/{id}/reject", "/api/v1/transfer-requests/{id}/cancel", "/api/v1/maintenances/add/{carId}", "/api/v1/maintenances/update/{id}", "/api/v1/maintenances/delete/{id}", "/api/v1/maintenances/get/{carId}", "/api/v1/maintenances/upload-invoice/{id}", "/api/v1/maintenances/download-invoice/{id}", "/api/v1/maintenances/delete-invoice/{id}", "/api/v1/payments/card", "/api/v1/payments/subscription/user/{userId}/plan/{planType}/billing/{billingCycle}", "/api/v1/payments/status/{paymentId}", "/api/v1/payments/subscription/{userId}/cancel", "/api/v1/payments/subscription/{userId}/status", "/api/v1/reminders/add/{carId}", "/api/v1/reminders/update/{id}", "/api/v1/reminders/delete/{id}", "/api/v1/reminders/get/{carId}", "/api/v1/reminders/generate-maintenance/{carId}").hasAuthority("USER")
